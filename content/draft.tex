...
the 50s and 60s, \acr{gisc} saw its first explorations during this time.
...
computers with \acr{gis} more accessible.

In the 90s \acr{gps} and remote sensing became more integrated with
\acr{gis}, and accurate and real-time data collection became a thing.
...
service in this regard is \acr{osm}.

The 2000s saw the proliferation of web-based mapping services, and the use of
\acr{gis} in fields such as epidemiology, transportation planning etc.
The use of \acr{gis} has become widespread in government, business and
academia.
